...
*/
  ...
  setData = async (appSettings: AppSettings, appGlobals: IAppGlobals) => {
    ...
    let battleMechSaves: IBattleMechExport[] = await getBattleMechSaves(
      appSettings
    );
    let asImportFavorites: IASGroupExport[] = await getFavoriteASGroups(
      appSettings
    );
    ...
    let bmImportFavorites: ICBTGroupExport[] = await getFavoriteCBTGroups(
      appSettings
    );
    ...
    let bmfImport: ICBTForceExport | null = await getCurrentCBTForce(
      appSettings
    );
  ...
  render = (): JSX.Element => {
    return (
      <AuthProvider>
        <RemoteDataProvider
          onUpdateConfig={(data) =>
            this.setData(this.state.appGlobals.appSettings, {
              ...this.state.appGlobals,
              currentASForce: data.currentASForce,
              favoriteASGroups: data.favoriteASGroups,
            })
          }
        >
          <Modal
          ...
          <Router>
            <Routes>
              ...
              <Route
                ...
                element={
                  <DevelopmentStatus appGlobals={this.state.appGlobals} />
                }
              />
              <Route
              ...
              <Route
                ...
                element={
                  <AlphaStrikeRouter appGlobals={this.state.appGlobals} />
                }
              />
              <Route
              ...
              />
              <Route
                path={`${process.env.PUBLIC_URL}/game-management/*`}
                element={
